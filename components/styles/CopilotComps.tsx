...
import { colors, deviceType, screenDimensions } from './globalStyles';
...
export const CustomTooltip: React.FC<{
    ...
    const handleNext = () => {
        if (currentStep?.order === 0) {
            ...
            setextraStepTracker(3);
        } else if (currentStep?.order === 13 && extraStepTracker === 3) {
            setextraStepTracker(4);
        } else if (currentStep?.order === 13 && extraStepTracker === 4) {
            setextraStepTracker(0);
            goToNext();
        } else {
            goToNext();
    ...
    const displayText = currentStep?.order === 13 && currentStep?.name === 'CompLogicTip'
        ? extraStepTracker === 1
            ...
            : "Tap on a box for an explanation of its contents."
    ...
    return (
        <View
            style={{
                ...
                width: deviceType() === 'Tablet' ? screenDimensions.screenWidth * 0.65 : screenDimensions.screenWidth * 0.75,
